...
| ~~H18~~ | #22 My Community (rendimiento) | ✅ **Índice `sponsor_id_1` creado 2026-09-23** (autorizado por el dueño): árbol de GEM-3 de 7,2 s → 3,6 s. El resto es el coste de 1 consulta por nodo (1.625 idas y vueltas); bajarlo a <0,5 s requiere cambiar el endpoint a una sola consulta `$graphLookup` (código) | — |
